    ...
    switch(opt) {
      ...
      case 'e':
        ...
        if((i >= PI_MIN_DMA_CHANNEL) && (i <= PI_MAX_DMA_CHANNEL))
          ...
          fatal("invalid -e option (%d)", i);
        break;

      case 'f': ifFlags |= PI_DISABLE_FIFO_IF; break;

      case 'g': foreground = 1; break;

      case 'k': ifFlags |= PI_DISABLE_SOCK_IF; break;

      case 'l': ifFlags |= PI_LOCALHOST_SOCK_IF; break;

      case 'm': ifFlags |= PI_DISABLE_ALERT; break;
      ...
      case 'n':
        ...
        if(addr && (numSockNetAddr < MAX_CONNECT_ADDRESSES))
          ...
          fatal("invalid -n option (%s)", optarg);
        break;
      ...
      case 's':
        ...
        switch(i) {
          ...
          case 5:
          case 8:
          case 10: clockMicros = i; break;

          default: fatal("invalid -s option (%d)", i); break;
        }
        break;
      ...
      case 'x':
        ...
        if(!err) {
          ...
          fatal("invalid -x option (%s)", optarg);
        break;
